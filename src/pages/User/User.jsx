...
const User = () => {
    ...
    let data3 = [
        {userId: 123, imgSrc:userImg, userName: "Rishi Khale", reviews: 200, followers: "123"},
        {userId: 123, imgSrc:userImg, userName: "Atharva Borkar", reviews: 200, followers: "123"},
        {userId: 123, imgSrc:userImg, userName: "Rishi Khale", reviews: 200, followers: "123"},
        {userId: 123, imgSrc:userImg, userName: "Atharva Borkar", reviews: 200, followers: "123"}
    ]
    ...
    <div className={css.box}>
      ...
      <div className={css.mainbody}>
        <div className={css.leftBox}>
          ...
          <LeftSideCardPanel name='ADVANCE BOOKING' data={data5} />
          <SuggestedFollowCard name='SUGGESTED FOODIES TO FOLLOW' data={data3} />
          <ProfileWidget name='Women Buisness PROFILE WIDGET' tag="Showcase your Women Buisness profile on your blog." data={data4} />
        </div>
