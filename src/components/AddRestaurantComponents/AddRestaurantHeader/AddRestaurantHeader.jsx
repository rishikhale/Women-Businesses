    ...
    let toggleBanner = toogleMenu ? (<div className={css.banner}>
        ...
        <div className={css.bannerInner}>
            ...
            <div className={css.bannerTxt}>
                <div className={css.title}>Register your business</div>
                <div className={css.tag}>for free and get more customers!</div>
                <div className={css.btns}>
                    <Link to='/' className={css.btn}>Register your business</Link>
                    <Link to='/' className={css.btn}>Business already listed? Claim now</Link>
                </div>
            </div>
        </div>
