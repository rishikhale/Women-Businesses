    ...
    let toggleBanner = toogleMenu ? (<div className={css.banner}>
        ...
        <div className={css.bannerInner}>
            ...
            <div className={css.bannerTxt}>
                <div className={css.title}>Women businesses</div>
                <div className={css.tag}>Discover different business and services by womens<span className={css.bld}> Mumbai</span></div>
