        ...
        <div className={signupCss.modal}>
            ...
            <div className={signupCss.lgBox}>
                ...
                <span className={signupCss.termsTxt}>
                    ...
                    <span>
                        I agree to this <a href="" className={signupCss.termaAnchor}>Terms of Service, Privacy Policy</a> and <a href="" className={signupCss.termaAnchor}>Content Policies</a>
                    </span>
                </span>
