  ...
  return <>
    ...
    <div className={css.bodySize}>
      <div className={css.chooseTypeCards}>
        <SmallCard imgSrc={orderOnlineImg} text="Tiffin" link={"/show-case?page=" + orderOnlinePage} />
        <SmallCard imgSrc={diningoutImg} text="Baking" link={'/show-case?page=' + diningOutPage} />
        <SmallCard imgSrc={proandproplusImg} text="Painting" link={'/show-case?page=' + proAndProPlusPage} />
        <SmallCard imgSrc={nightlifeandclubsImg} text="Tailoring" link={'/show-case?page=' + nightLifePage} />
      </div>
      {/* <Collections /> */}
      <PopularPlaces />
    </div>
